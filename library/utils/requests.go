...
func GetHtmlDoc(url string) (*goquery.Document, error) {
	...
	request.Header.Add("Origin", "https://www.xbiquge.la")
	request.Header.Add("Host", "www.xbiquge.la")
...
func PostHtmlDoc(URL string, form url.Values) (*goquery.Document, error) {
